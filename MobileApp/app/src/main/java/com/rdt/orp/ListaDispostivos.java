...
public class ListaDispostivos extends ListActivity {
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        //Toast.makeText(getApplicationContext(),"MAC FINAL" + informacaoGeral,Toast.LENGTH_LONG).show();

        String enderecoMac = informacaoGeral.substring(informacaoGeral.length() - 17);
       // Toast.makeText(getApplicationContext(),"MAC FINAL" + enderecoMac,Toast.LENGTH_LONG).show();
